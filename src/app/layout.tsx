...
export const metadata: Metadata = {
  ...
  description:
    'AI-powered bone lesion detection and classification using YOLOv8 + EfficientNet-B3. Upload a radiograph to detect and classify bone lesions with Grad-CAM explanations.',
